...
// partiendo de que ya tenemos creado un objecto ProductData previamente utilizamos el contexto
	public function update(){
		$sql = "update ".self::$tablename." set nombre=\"$this->nombre\",direccion=\"$this->direccion\",estado=\"$this->estado\",telefono=\"$this->telefono\",fax=\"$this->fax\",rnc=\"$this->rnc\",registro_empresarial=\"$this->registro_empresarial\",ciudad=\"$this->ciudad\",iva=$this->iva where id=$this->id";
		Executor::doit($sql);
	}
