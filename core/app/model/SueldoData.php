...
class SueldoData {
	...
	public function getUsuario(){ return PersonaData::getById($this->id_usuario);}
...
// partiendo de que ya tenemos creado un objecto CategoryData previamente utilizamos el contexto
	...
	public function updateSueldo(){
		$sql = "update ".self::$tablename." set id_usuario=$this->id_usuario,monto=\"$this->monto\",dia_pago=\"$this->dia_pago\",fecha_comienzo=\"$this->fecha_comienzo\" where id=$this->id";
		Executor::doit($sql);
	}
