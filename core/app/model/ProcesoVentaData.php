...
class ProcesoVentaData {
	...
	public function add(){ 
		$sql = "insert into proceso_venta (id_producto,id_operacion,id_venta,cantidad,precio,fecha_creada,id_caja,id_usuario,id_tipopago) ";
		$sql .= "value ($this->id_producto,$this->id_operacion,$this->id_venta,$this->cantidad,\"$this->precio\",\"$this->fecha_creada\",$this->id_caja,$this->id_usuario,$this->id_tipopago)";
		return Executor::doit($sql);
	} 

	public function addCompra(){  
		$sql = "insert into proceso_venta (id_producto,id_venta,cantidad,precio,tipo_operacion,fecha_creada,id_caja,id_usuario,id_tipopago) ";
		$sql .= "value ($this->id_producto,$this->id_venta,$this->cantidad,\"$this->precio\",2,$this->fecha_creada,$this->id_caja,$this->id_usuario,$this->id_tipopago)";
		return Executor::doit($sql);
	}
...
// partiendo de que ya tenemos creado un objecto PersonaData previamente utilizamos el contexto
	...
	public function updateCreditoCompra(){
	...
	public function updateFecha(){
		$sql = "update ".self::$tablename." set fecha_creada=\"$this->fecha_creada\",id_tipopago=$this->id_tipopago where id=$this->id";
		Executor::doit($sql);
	}
	...
	public static function getAllEntradasMes($id_producto,$mes,$anio){
		$sql = "select * from ".self::$tablename." where tipo_operacion=2 and id_tipopago!=4 and id_producto=$id_producto and month(fecha_creada) = \"$mes\" and year(fecha_creada) = \"$anio\" "; 
		$query = Executor::doit($sql);
		return Model::many($query[0],new ProcesoVentaData());
	}
	...
	public static function getByAllCompra($id){
		$sql = "select * from ".self::$tablename." where id_venta=$id and id_tipopago!=4  ";
		$query = Executor::doit($sql);
		return Model::many($query[0],new ProcesoVentaData());
	...
	public static function getReporteDiario($hoy){
		$sql = "select * from ".self::$tablename." where date(fecha_creada) = \"$hoy\" and tipo_operacion=1 and id_tipopago!=4 ";
		$query = Executor::doit($sql);
		return Model::many($query[0],new ProcesoVentaData());
	...
	public static function getIngresoCajaTipoDocumento($id_caja,$id_tipopago){
		$sql = "select * from ".self::$tablename." where id_caja=$id_caja and id_tipopago=$id_tipopago and date(fecha_creada) != 'NULL' and tipo_operacion=1 ";
		$query = Executor::doit($sql);
		return Model::many($query[0],new ProcesoVentaData());
	}
	...
	public static function getFechaGraficoEgreso($anio,$mes){
		$sql = "select * from ".self::$tablename." where year(fecha_creada) = $anio  and month(fecha_creada) = $mes  and date(fecha_creada) != 'NULL' and tipo_operacion=2 and id_tipopago!=4 ";
		$query = Executor::doit($sql);
		return Model::many($query[0],new ProcesoVentaData());
	}
 
	public static function getEgresoCaja($id_caja){
		$sql = "select * from ".self::$tablename." where id_caja=$id_caja and date(fecha_creada) != 'NULL' and tipo_operacion=2 and id_tipopago!=4 ";
		$query = Executor::doit($sql);
		return Model::many($query[0],new ProcesoVentaData());
	}

	public static function getIngresoRangoFechasEgreso($start,$end){
		$sql = "select * from ".self::$tablename." where date(fecha_creada) >= \"$start\" and date(fecha_creada) <= \"$end\" and date(fecha_creada) != 'NULL' and tipo_operacion=2 and id_tipopago!=4 ";
		$query = Executor::doit($sql);
		return Model::many($query[0],new ProcesoVentaData());
	}
	...
	public static function getReporteMensual11Compra($dia,$mes){
		$sql = "select * from ".self::$tablename." where day(fecha_creada) = \"$dia\"  and month(fecha_creada) = \"$mes\" and tipo_operacion=2 and id_tipopago!=4 ";
		$query = Executor::doit($sql);
		return Model::many($query[0],new ProcesoVentaData());
	...
	public static function getFiltroFechas($start,$end){
 		$sql = "select * from ".self::$tablename." where date(fecha_creada) >= \"$start\" and date(fecha_creada) <= \"$end\" and tipo_operacion=1   group by id desc";
		$query = Executor::doit($sql);
		return Model::many($query[0],new ProcesoVentaData());
	}

	public static function getFiltroFechasVenta($start,$end){
 		$sql = "select * from ".self::$tablename." where date(fecha_creada) >= \"$start\" and date(fecha_creada) <= \"$end\" and tipo_operacion=1  and id_tipopago!=4 ";
		$query = Executor::doit($sql);
		return Model::many($query[0],new ProcesoVentaData());
	}

	public static function getFiltroFechasVentaProduct($start,$end,$product){
 		$sql = "select * from ".self::$tablename." where date(fecha_creada) >= \"$start\" and date(fecha_creada) <= \"$end\" and tipo_operacion=1  and id_producto=$product  ";
		$query = Executor::doit($sql);
		return Model::many($query[0],new ProcesoVentaData());
	}
