	...
	$del->del();
		...
		$tmps = TmpData::getAllTemporal($session_id);
			...
			foreach($tmps as $tmp): ?>
                ...
                <td>C$    <?php echo number_format($tmp->precio_tmp,2,'.',','); ?></td>
                <?php $sumar_t=$tmp->cantidad_tmp*$tmp->precio_tmp; ?>
                <td>C$    <?php echo number_format($sumar_t,2,'.',','); ?></td>
            ...
            <tr style="background-color: #f3f3f3;">
                ...
                <td><span class="pull-left"><?php echo 'C$    '.number_format($sumador_total,2,'.',',');?></span></td>
                <td></td>
            </tr>
            <tr style="background-color: #f3f3f3;">
                <td colspan=4><span class="pull-right">IVA </span></td>
                <td><span class="pull-left"><?php echo 'C$   '.number_format($sumador_total*$iva_sp,2,'.',',');?></span></td>
                <td></td>
            </tr>
            <tr style="background-color: #e4e4e4;">
                <td colspan=4><span class="pull-right">TOTAL </span></td>
                <td><span class="pull-left"><?php echo 'C$   '.number_format($sumador_total+($sumador_total*$iva_sp),2,'.',',');?></span></td>
                <td></td>
            </tr>
            <?php }; ?>