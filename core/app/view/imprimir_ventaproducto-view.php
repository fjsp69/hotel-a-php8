                                                            ...
                                                            <?php $productos = ProcesoVentaData::getVenta($operacion->id);
                                                               ...
                                                               <?php foreach($productos as $producto):?>
                                                                ...
                                                                <tr>
                                                                  ...
                                                                  <td><b>C$    <?php echo number_format($sub_total,2,'.',','); ?></b></td>
                                                ...
                                                <section class="tile tile-simple bg-tr-black lter">
                                                    ...
                                                    <div class="tile-body">
                                                        ...
                                                        <ul class="list-unstyled" style="background-color: #493d55;color: white;">
                                                            ...
                                                            <li class="ng-binding"><strong class="inline-block w-sm mb-5">Efectivo:</strong> C$    <?php echo number_format($operacion->efectivo,2,'.',','); ?> </li>
                                                            <li class="ng-binding"><strong class="inline-block w-sm mb-5">Tarjeta:</strong>  C$    <?php echo number_format($operacion->tarjeta,2,'.',','); ?></li>
