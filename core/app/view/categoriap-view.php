  ...
  <div class="col-md-12">
    <section class="tile">
      <div class="tile-header dvd dvd-btm">  
        <h1 class="custom-font"><strong>REGISTRO DE</strong> CATEGORÍAS DE PRODUCTOS</h1>
        <ul class="controls">
          <li class="remove">
          ...
          <input id="filter" type="text" class="form-control input-sm w-sm mb-12 inline-block"/>
              ...
              <?php $categorias = CategoriaProData::getAll();
                if(@count($categorias)>0){
                  // si hay usuarios
                  ?>
                  <table id="searchTextResults" data-filter="#filter" data-page-size="50" class="footable table table-custom" style="font-size: 11px;">
...
<div class="modal fade bs-example-modal-xm" id="myModalDel<?php echo $categoria->id; ?>" role="dialog" aria-labelledby="myModalLabel">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <a href="index.php?view=delcategoriap&id=<?php echo $categoria->id; ?>"   class="btn btn-danger"><i class="glyphicon glyphicon-trash"></i> Eliminar de todos modos</a>
    ...
    <div class="modal fade bs-example-modal-xm" id="myModal<?php echo $categoria->id; ?>" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog modal-warning">
          <div class="modal-dialog">
            <div class="modal-content">
                <form class="form-horizontal" method="post" id="addproduct"  enctype="multipart/form-data" action="index.php?view=updatecategoriapro" role="form">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title"><span class="fa fa-sitemap"></span> EDITAR CATEGORÍA </h4>
              </div>
              <div class="modal-body" style="background-color:#fff !important;">
      ...
      <div class="modal fade bs-example-modal-xm" id="myModal" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog modal-success">
          <div class="modal-dialog">
            <div class="modal-content">
                <form class="form-horizontal" method="post" id="addproduct" enctype="multipart/form-data" action="index.php?view=addcategoriapro" role="form">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
