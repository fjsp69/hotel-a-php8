  ...
  <div class="col-md-12">
    ...
    <section class="tile">
      <div class="tile-header dvd dvd-btm">    
        ...
        <h1 class="custom-font"><strong>PAGOS PARA</strong> <?php echo $sueldo->getUsuario()->nombre; ?></h1>
        <ul class="controls">
          <li class="remove">
                ...
                <div class="col-md-offset-1 col-md-10">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="monto" onchange="this.value=this.value.replace(/\.$/, '')"  onKeyUp="if (isNaN(this.value)) this.value=this.value.replace(/[^0-9.]/g,'')" required placeholder="Ejem. 180" value="<?php echo $sueldo->monto-($pago+$descuento); ?>">
                    </div>
                  </div>
