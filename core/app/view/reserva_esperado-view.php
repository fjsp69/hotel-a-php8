...
<section class="content-header">
    <ol class="breadcrumb">
      ...
      <li class="active"><a href="#">Reporte esperado</a></li>
    </ol>
</section> 
	  ...
	  <div class="row">
		 <div class="breadcrumb col-lg-12">
				...
				text-align: center; text-transform: uppercase;font-weight: bold;width: 100%;">
					<span>
					RESERVAS POR MES ESPERADO</span>
			    </div>
	   	  </div>
	  </div>
	</div>
        ...
        <div class="form-group">
          <div class="row">
            <div class="col-sm-2">
              ...
              <input type="hidden" name="view" value="reserva_esperado">
...
<table id="searchTextResults" data-filter="#filter" data-page-size="32" class="footable table table-custom" style="font-size: 11px;">
            <tr class="tr" style="width: 100%; ">
                ...
                <th>RESERVA ESPERADAS</th>
                <th>RENDIMIENTO DE RESERVAS</th>
            </tr>
<?php
$egreso=0;
...
?>
    ...
    case 6: echo "Sabado".', '.$numero1.' de '.$mes; break;
              ...
              <?php $esperado = EsperadoData::getAllMesAnio($_GET["mes"],$_GET["anio"]);
                if(count($esperado)>0){

                $esperado01=$esperado->cantidad;
                echo $esperado01;
                ...
                <td ><?php if($recibida01!='0' and $esperado01!='0'){ echo number_format((100*$recibida01)/$esperado01,0,'.',',').' %';}else{echo "0%";} ?></td>
</tr>
<?php
};
