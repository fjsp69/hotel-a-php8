...
<section class="content-header">
    <ol class="breadcrumb">
      ...
      <li class="active"><a href="#">Otros ingresos</a></li>
    </ol>
</section> 
</div> 
  ...
  <div class="col-md-12">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs" style="background-color: #d2d6de;">
              <li class="active"><a href="#tab_1" data-toggle="tab">Lista de otros ingresos</a></li>
              <li><a href="#tab_2" data-toggle="tab">Otros ingresos anulados</a></li>
              <!--
              ...
              <div class="tab-pane active" id="tab_1">
                ...
                if(@count($gastos)>0){  ?>
                  ...
                  <thead style="color: black; background-color: #d2d6de;">
                        ...
                        <th data-hide="phone">Tipo pago</th>
                   ...
                   <?php foreach($gastos as $gasto):?> 
                      <tr>
                        ...
                        <td><?php echo $gasto->getTipopago()->nombre; ?></td>
        ...
        <div class="modal-dialog modal-warning">
          <div class="modal-dialog">
            <div class="modal-content">
                <form class="form-horizontal" method="post" id="addproduct" action="index.php?view=anular_ingreso" role="form">
        ...
        <!-- /.modal -->
            ...
            echo"<h4 class='alert alert-success'>NO HAY REGISTRO</h4>";
              ...
              <div class="tab-pane" id="tab_2">
                <?php if(isset($_GET['start']) and $_GET['start']!="" and isset($_GET['end']) and $_GET['end']!=""){
                  $gastos = GastoData::getFiltroFechasAnuladoIngreso($_GET['start'],$_GET['end']);
                }else{
                  $gastos = GastoData::getAllAnuladoIngreso(); 
                } ?> 
                <?php  
                if(@count($gastos)>0){  ?>
                  <table id="searchTextResults" data-filter="#filter" data-page-size="7" class="footable table table-custom" style="font-size: 11px;">
