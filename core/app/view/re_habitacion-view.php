...
<section class="content-header">
    <ol class="breadcrumb">
      ...
      <li class="active">Config. habitación reserva</li>
    </ol>
</section> 
</div> 
  ...
  <div class="col-md-12">
    <section class="tile">
      <div class="tile-header dvd dvd-btm">  
        <h1 class="custom-font"><strong>REGISTRO DE</strong> HABITACIÓN</h1>
        <ul class="controls">
          <li class="remove">
            <a  data-toggle="modal" data-target="#myModal"  ><i class="fa fa-user-plus"></i> REGISTRAR NUEVA HABITACIÓN</a>
          </li>
          <li class="dropdown">
      ...
      <div class="tile-body">
        <div class="form-group">
          ...
          <input id="filter" type="text" class="form-control input-sm w-sm mb-12 inline-block"/>
              ...
              <?php $shreservas = SHreservaData::getAllHabitacion();
                ...
                <div class="col-md-12">
                   ...
                   <div class="form-group">
                    <div class="input-group">
                      <b > Puede afectar a algunos registros que contengan esta HABITACIÓN </b>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title"> EDITAR HBAITACIÓN</h4>
              </div>
              <div class="modal-body" style="background-color:#fff !important;">
              ...
              <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-outline"  name="habitacion">Actualizar Datos</button>
              </div>
            </form>
            </div>
            <!-- /.modal-content -->
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title"> INGRESAR NUEVA HABITACIÓN</h4>
              </div>
              <div class="modal-body" style="background-color:#fff !important;">
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Cerrar</button>
                <input type="hidden"  name="tipo" value="2">
                <button type="submit" class="btn btn-outline" name="habitacion">Agregar Datos</button>
              </div>
            </form>
            </div>
            <!-- /.modal-content -->
