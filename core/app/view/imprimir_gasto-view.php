 ...
 <section class="content-header">
     <div class="nav-heading">
                                ...
                                <span class="controls pull-right">
                                  <a href="index.php?view=egreso" class="btn btn-ef btn-ef-1 btn-ef-1-default btn-ef-1a btn-rounded-20 mr-5" data-toggle="tooltip" title="Egreso"><i class="fa fa-times"></i></a>
              ...
              <?php $gasto = GastoData::getById($_GET['id']);
                if(@count($gasto)>0){
                  ...
                  <thead style="color: white; background-color: #dd4b39;">
                        <th colspan="2" style="text-align: center;">Nº DE TICKET - <?php echo 'EGRE'.$gasto->id; ?> -</th> 
                        <th></th> 
                  </thead>
                    
                    <tr>
                        <td>Código</td>
                        <td><?php echo 'EGRE-'.$gasto->id; ?></td>
                        <td></td>
                      </tr> 
