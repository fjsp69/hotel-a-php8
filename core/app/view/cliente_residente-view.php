                ...
                <div class="col-md-offset-1 col-md-10">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control col-md-8" name="telefono"  placeholder="Ingrese Número (OPCIONAL)" value="<?php echo $cliente->telefono; ?>" >
                    </div>
                  </div>

                  <div class="form-group">
                    <div class="input-group">
                      <span class="input-group-addon"> Grupo sanguíneo</span>
                      <input type="text" class="form-control col-md-8" name="celular"  placeholder="Ingrese  grupo sanguíneo (OPCIONAL)" value="<?php echo $cliente->celular; ?>" >
                    </div>
                  </div>

                  <div class="form-group">
                    <div class="input-group">
                      <span class="input-group-addon"> Alérgico &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <span class="input-group-addon"> Observación &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                       <input type="text" class="form-control col-md-8" name="motivo"  placeholder="Ingrese observación (OPCIONAL)" value="<?php echo $cliente->motivo; ?>">
                    </div>
                  </div>
              ...
              <div class="modal-body" style="background-color:#fff !important;">
                ...
                <div class="col-md-offset-1 col-md-10">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <span class="input-group-addon"> Número &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                      <input type="text" class="form-control col-md-8" name="telefono"  placeholder="Ingrese Número (OPCIONAL)">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <span class="input-group-addon"> Grupo sanguíneo</span>
                      <input type="text" class="form-control col-md-8" name="celular"  placeholder="Ingrese  grupo sanguíneo (OPCIONAL)">
                    </div>
                  </div>
