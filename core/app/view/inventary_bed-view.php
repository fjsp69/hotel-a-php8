  ...
  <div class="col-md-12">
    <section class="tile">
      <div class="tile-header dvd dvd-btm">  
        <h1 class="custom-font"><strong>REGISTRO DE</strong> INVENTARIO DE HABITACIÓN</h1>
        <ul class="controls">
          <li class="remove">
      ...
      <div class="tile-body">
        <div class="form-group">
          ...
          <input id="filter" type="text" class="form-control input-sm w-sm mb-12 inline-block"/>
              ...
              <?php $inventaries = InventaryBedData::getAll($_GET['id']);
    ...
    <div class="modal fade bs-example-modal-xm" id="myModal<?php echo $inventary->id; ?>" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog modal-warning">
          <div class="modal-dialog">
            <div class="modal-content">
                <form class="form-horizontal" method="post" id="addproduct"  enctype="multipart/form-data" action="index.php?view=updateinventarybed" role="form">
                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control col-md-8"  name="quantity"  value="<?php echo $inventary->quantity; ?>" required placeholder="Ingrese Nombre">
                    </div>
                  </div>
      ...
      <div class="modal fade bs-example-modal-xm" id="myModal" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog modal-success">
          <div class="modal-dialog">
            <div class="modal-content">
                <form class="form-horizontal" method="post" id="addproduct" enctype="multipart/form-data" action="index.php?view=addinventarybed" role="form">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
              ...
              <div class="modal-body" style="background-color:#fff !important;">
                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <span class="input-group-addon"> Cantidad </span>
                      <input type="text" class="form-control col-md-8"  name="quantity" required placeholder="Ingrese Nombre">
                    </div>
                  </div>
